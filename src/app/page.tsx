...
const MessengerIcon = () => (
  <svg 
    ...
    className="h-5 w-5"
  >
    <path d="M12 2.03125C6.48828 2.03125 2 6.04297 2 11C2 13.5977 3.54688 15.8984 6 17.1602V20.5312C6 20.8008 6.28906 21 6.53125 21C6.60156 21 6.668-0.00390625 6.73047 20.9805L9.62891 19.2305C10.375 19.4414 11.168 19.5312 12 19.5312C17.5117 19.5312 22 15.5195 22 11C22 6.04297 17.5117 2.03125 12 2.03125Z" />
    <path d="M8.5 9.5L14 12.5L15.5 8L10 5Z" fill="white" />
  </svg>
);
